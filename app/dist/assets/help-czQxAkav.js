function i(){const e=document.createElement("div");e.style.cssText="position:fixed; inset:0; z-index:9999; display:flex; align-items:center; justify-content:center; background:rgba(0,0,0,0.75); backdrop-filter:blur(6px);",e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("video"),o=e.querySelector(".video-placeholder");t.addEventListener("play",()=>{o&&(o.style.display="none")}),e.querySelector("#help-bk-close").onclick=()=>{t.pause(),e.remove()}}export{i as showHelpModal};
