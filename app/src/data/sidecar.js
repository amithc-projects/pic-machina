...
export const SIDECAR_SCHEMA_KEYS = [
  ...
  'sidecar.poseLabel',
  'sidecar.blurLabel',
  'sidecar.sharpnessScore',

  // Standard Schema Paths (Nested)
  ...
  'sidecar.asset.title',
  'sidecar.asset.captureDate',
  'sidecar.asset.captureTimeApprox',
  'sidecar.asset.format',
  'sidecar.asset.resolution',
  'sidecar.asset.widthPx',
  'sidecar.asset.heightPx',
  'sidecar.asset.aspectRatio',
  'sidecar.asset.orientation',
  'sidecar.asset.durationSec',
  'sidecar.asset.fps',
  'sidecar.asset.rightsNotes',
  'sidecar.asset.contentRating',
  'sidecar.asset.analysisConfidence',
  'sidecar.geo.city',
  'sidecar.geo.region',
  'sidecar.geo.country',
  ...
  'sidecar.analysis.generatedAt',
  'sidecar.analysis.generatedBy',
  'sidecar.analysis.computed.sharpnessScore',
  'sidecar.analysis.computed.blurLabel',
  'sidecar.analysis.computed.ocrText',
  'sidecar.analysis.computed.ocrTags',
  'sidecar.analysis.computed.faceCount',
  'sidecar.analysis.computed.personCount',
  'sidecar.analysis.computed.poseLabel',
  'sidecar.analysis.computed.peopleLabel',
...
export const SIDECAR_SCHEMA_GROUPS = [
  {
    ...
    defaultOpen: true,
    keys: [
      { key: 'sidecar.city',           label: 'City (Alias)' },
      { key: 'sidecar.country',        label: 'Country (Alias)' },
      { key: 'sidecar.rating',         label: 'Rating (Alias)' },
      { key: 'sidecar.flag',           label: 'Flag (Alias)' },
      { key: 'sidecar.peopleLabel',    label: 'People Label (Alias)' },
      { key: 'sidecar.ocrText',        label: 'OCR Text (Alias)' },
    ],
  },
  {
    title: 'Annotation',
  ...
  },
  {
    ...
    keys: [
      ...
      { key: 'sidecar.asset.captureDate',        label: 'Capture Date'   },
      { key: 'sidecar.asset.format',             label: 'Format'         },
      { key: 'sidecar.asset.resolution',         label: 'Resolution'     },
      { key: 'sidecar.asset.widthPx',            label: 'Width (px)'     },
      { key: 'sidecar.asset.heightPx',           label: 'Height (px)'    },
      { key: 'sidecar.asset.aspectRatio',        label: 'Aspect Ratio'   },
      { key: 'sidecar.asset.orientation',        label: 'Orientation'    },
  ...
  },
  {
    ...
    defaultOpen: false,
    keys: [
      { key: 'sidecar.analysis.computed.sharpnessScore', label: 'Sharpness Score' },
      { key: 'sidecar.analysis.computed.blurLabel',      label: 'Blur Label'      },
      { key: 'sidecar.analysis.computed.ocrText',        label: 'OCR Text'        },
      { key: 'sidecar.analysis.computed.peopleLabel',    label: 'People Description' },
      { key: 'sidecar.analysis.computed.faceCount',      label: 'Face Count'      },
      { key: 'sidecar.analysis.computed.personCount',    label: 'Person Count'    },
      { key: 'sidecar.analysis.computed.poseLabel',      label: 'Pose Label'      },
      { key: 'sidecar.computed.sharpnessScore',          label: 'Sharpness Score (v1)' },
      { key: 'sidecar.computed.blurLabel',               label: 'Blur Label (v1)'      },
    ],
  },
  {
    title: 'Source',
