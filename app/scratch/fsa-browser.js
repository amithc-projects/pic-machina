  ...
  initDOM() {
    this.container.innerHTML = `
      <div style="display:flex; flex-direction:column; height: 100%; width: 100%; background: var(--ps-bg-surface); border-left: 1px solid var(--ps-border);">
         ...
         <div style="display:flex; align-items:center; gap: 8px; padding: 8px 12px; border-bottom: 1px solid var(--ps-border);">
            <select id="fsa-recent-select" class="input-field flex-1" style="font-size:12px; padding:4px 8px;">
