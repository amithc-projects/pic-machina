...
*   `{{autoCaptions}}` - Variable generated by `ai-transcribe` containing SRT subtitle formatted text. Can be mapped directly into `overlay-subtitles` or `overlay-html-block`!
